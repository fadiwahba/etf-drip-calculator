...
export default function Home() {
  ...
  return (
    <main className="min-h-screen p-6 bg-gray-50 flex flex-col items-center">
      <h1 className="text-lg md:text-3xl font-black uppercase mb-8 bg-gradient-to-r from-indigo-500 via-pink-500 to-amber-500 text-transparent bg-clip-text">
        ...
        <CardContent>
          ...
          >
            ...
            <div className="sm:col-span-2 flex justify-center mt-4">
              <Button
                type="submit"
                className="bg-indigo-500 transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-teal-200 hover:bg-teal-400"
              >
